...
<!-- mv详情 -->
  <div class="mvinfo">
      <div class="content">
            ...
            <div class="info-wrap">
                <div class="singer-info">
                    <div class="auther-wrap" style="margin-top:10px">
                        <!-- 头像 -->
                        <img :src="icon" class="img-round" width="50" height="50" alt="" />
                        <!-- 歌手名 -->
                ...
                <div class="mv-info">
                    ...
                    <!-- 描述 -->
                    <p class="desc" style="margin:10px 0px 0px 10px;" v-html="replace(mv.desc)">
                    </p>
        ...
        <!-- 评论 -->
        <div class="comments">
            <h3>评论</h3><span class="info-grey">共{{total}}条评论</span>
            <div class="comment" v-if="total!=0">
                <div v-if="topcomments.length!=0">
                    <h2>置顶</h2>
                    <div>
                        <div class="item comment-all" v-for="{item,index} in topcomments" :key="index" >
                ...
                <div v-if="hotcomments.length!=0">
                    <h2>精彩评论</h2>
                    <div class="item comment-all" v-for="{item,index} in hotcomments" :key="index" >
                ...
                <div> 
                    <h2>最新评论</h2>
                    <div class="item comment-all" v-for="item in comments" :key="item.id" >
                        ...
                        <div class="comment-right">
                            ...
                            <!-- 回复 -->
                            <div v-if="item.beReplied.length!=0" class="conment-beReplied">
                                <div class="item comment-all" v-for="i in item.beReplied" :key="i" >
                                    <div class="column-wrap comment-user">
                                        <a class="nickname">{{i.user.nickname}}</a>
                                        <img width="50" height="50" :src="i.user.avatarUrl" alt="">
                                    </div>
                                    <div class="comment-right">
                                        <div class="comment-center">
      ...
      <div class="simi">
          <div class="mv">
              <div class="items">
                  <div class="item card" v-for="item in simimv" :key="item.id" @click="toMvInfo(item.id)">
                      <div class="img-wrap">
